...
- Name: tp_TC_001.spec.ts >> Jira Login Tests >> TC_01: Successful login with valid credentials
- Location: tests\tp_TC_001.spec.ts:12:3
...
- generic [ref=e4]:
  ...
  - generic [ref=e24]:
    ...
    - generic [ref=e28]:
      ...
      - textbox "Username" [ref=e31]: valid_user
      - textbox "Password" [active] [ref=e33]: valid_password
