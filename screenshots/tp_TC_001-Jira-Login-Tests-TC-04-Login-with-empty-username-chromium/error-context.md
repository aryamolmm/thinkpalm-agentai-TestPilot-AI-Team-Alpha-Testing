...
- Name: tp_TC_001.spec.ts >> Jira Login Tests >> TC_04: Login with empty username
- Location: tests\tp_TC_001.spec.ts:33:3
...
- generic [ref=e4]:
  ...
  - generic [ref=e24]:
    ...
    - generic [ref=e28]:
      ...
      - textbox "Password" [active] [ref=e35]: valid_password
