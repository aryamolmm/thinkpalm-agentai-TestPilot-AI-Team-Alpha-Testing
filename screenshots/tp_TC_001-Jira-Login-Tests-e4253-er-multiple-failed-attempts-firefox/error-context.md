...
Call log:
  - waiting for locator('.username')
    - locator resolved to <input type="text" _ngcontent-ltu-c31="" placeholder="Username" formcontrolname="userName" class="form-control form-control-sm login-textfield username ng-untouched ng-pristine ng-invalid"/>
    - fill("ship_test")
