...
- Name: tp_TC_001.spec.ts >> Jira Login Tests >> TC_06: Login with empty username and password
- Location: tests\tp_TC_001.spec.ts:45:3
  ...
  - generic [ref=e24]:
    ...
    - generic [ref=e28]:
      ...
      - generic [ref=e30]:
        ...
        - generic [ref=e33]: User name is required
      - generic [ref=e34]:
        - textbox "Password" [active] [ref=e35]
        - generic [ref=e37]: Password is required
