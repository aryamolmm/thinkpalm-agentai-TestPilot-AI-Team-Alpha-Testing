...
- Name: tp_TC_001.spec.ts >> Jira Login Tests >> TC_03: Login with invalid password
- Location: tests\tp_TC_001.spec.ts:26:3

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://192.168.2.67/login
Call log:
  - navigating to "http://192.168.2.67/login", waiting until "load"
