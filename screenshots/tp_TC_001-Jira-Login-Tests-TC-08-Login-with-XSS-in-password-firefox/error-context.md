...
- Name: tp_TC_001.spec.ts >> Jira Login Tests >> TC_08: Login with XSS in password
- Location: tests\tp_TC_001.spec.ts:57:3
...
- generic [ref=e3]:
  - alert [ref=e7]:
    - generic [ref=e8]: 
    - generic [ref=e9]:
      - generic [ref=e10]: Incorrect username or password
      - generic [ref=e11]: The username and password you entered do not match
  ...
  - alert [ref=e14]:
    - alert [ref=e15]:
      - generic [ref=e16]:
        - generic [ref=e17]: 
        - generic [ref=e18]: Warning!
        - generic [ref=e19]: Please use Google Chrome while accessing CPDSS. Other browsers may not support all features.
  ...
  - generic [ref=e22]:
    ...
    - generic [ref=e42]:
      - img [ref=e44]
      - generic [ref=e46]:
        - generic [ref=e47]: Registered Users
        - textbox "Username" [ref=e49]: valid_user
        - textbox "Password" [active] [ref=e51]: Think@123##
